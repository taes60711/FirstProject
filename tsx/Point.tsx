...
export function PointPage() {
    return (
        ...
        <View style={styles.container}>
          <View style={{width:'100%',height:130,backgroundColor:'#c1a38b',justifyContent:'center',alignItems:'center'}}>
          ...
          shadowOffset: {
            ...
            <ScrollView>
              <View style={styles.container}>
                <View style={{marginTop:15,marginHorizontal:15,width:'95%',height:120,borderWidth:1,borderColor:'#d6ab8b',borderRadius:3,flexDirection:'row',alignItems:'center'}}>
                  <View style={{width:'85%',height:'100%',flexDirection:'row'}}>
                    ...
                    <View style={{width:'60%',height:'100%'}}>
                      <View style={{height:'80%'}}>
                        <Text style={{fontSize:18,fontWeight:'700',color:'#d6ab8b',marginTop:10}}>商品名商品名商品名商品名</Text>
                        <Text style={{fontSize:12,color:'#494949',margin:3}}>説明用文字説明用文字説明用文字</Text>
                      </View>
                    ...
                    <View style={{width:'15%',height:'100%',justifyContent:'center',alignItems:'center',}}>
                        <Icons type={Iconss.MaterialIcons} name={'add-shopping-cart'} size={35} color={'#d6ab8b'}></Icons>
                      </View>
                  </View>
                </View>
                <View style={{marginTop:15,marginHorizontal:15,width:'95%',height:120,borderWidth:1,borderColor:'#d6ab8b',borderRadius:3,flexDirection:'row',alignItems:'center'}}>
